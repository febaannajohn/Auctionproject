                            ...
                            $res  = mysqli_query($conn, $sql);
                                ...
                                <tr>
                                   ...
                                   <!-- <td><?php  echo $data['catname'];?> </td>   -->
                                    <?php
                                echo "<td><a href='editproduct.php?subid=".$data['subid']."'><button class='btn btn-warning'>EDIT</button></a></td>";
                                ?>                                     
                                <?php
                               echo "<td><a href='deleteproduct.php?subid=".$data['subid']."'><button class='btn btn-danger'>DELETE</button></a></td>";
                               ?> 
                                </tr>
                                <?php
                                }}
