...
{
  $esel="SELECT * FROM tbl_cricket WHERE subid=".$_GET['pid'];
...
//    $uid=$_SESSION['id'];
  ...
  $sql = "INSERT INTO `bidding`(`subid`,`amt`,`userid`) VALUES ('$subid','$amount','$uid')";
...
<section class="ftco-section">
    	<div class="container">
          ...
          <div class="col-md-12 heading-section text-center ftco-animate">
            ...
            <p>Add Your Feed back. Our Feedback is surely consider the further Products</p>
          </div>
        </div>   		
    	</div>
    	<div class="container">
...
<h3 class="text-center pt-5">Our Customer Feedback</h3>
<div class="row mt-4">
...
?>
    ...
    <section class="ftco-section">
    	<div class="container">
				<div class="row justify-content-center pl-5" style="margin-left:115px;">
          <div class="col-md-12 heading-section text-center ftco-animate">
          	<span class="subheading">Products</span>
    	...
    	<div class="container">
    		<div class="row pl-5" style="margin-left:115px;">
    			<div class="col-md-6 col-lg-3 ftco-animate">
    				<div class="product">
      ...
      <div class="container py-4">
        <div class="row d-flex justify-content-center py-5" style="margin-left:115px;">
          <div class="col-md-12">
