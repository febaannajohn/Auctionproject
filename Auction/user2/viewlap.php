...
?>
    <div class="hero-wrap hero-bread" style="background-image: url('images/el.jpg');">
      <div class="container">
    		...
    		<div class="row justify-content-center">
    			<div class="col-md-10 mb-5 text-center">
    				<ul class="product-category">
    					<li><a href="shop1.php">Vechicles</a></li>
    					<li><a href="viewlap.php" class="active">Electronics</a></li>
